...
def base_config(cfg_dict):
    ...
    # Training schedule
    parser.add_argument('model_name', default='maxsum', help='Training model')
    ...
    # Dataset setting
    parser.add_argument('--trset', default='c', help='Set the traing set')
    ...
    parser.add_argument('--save_tar', default='',help='prediction map save path')
...
def cfg_convert(config):
    ...
    weight_path = os.path.join(config['weight_path'], config["save_tar"])
